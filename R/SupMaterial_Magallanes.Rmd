...
Table 2 is the species list with details on trophic species cases (aggregated taxa) and its properties (e.g. degree, closeness, betweenness, Keystone Species Index -KSI-, trophic position, and topological role).
