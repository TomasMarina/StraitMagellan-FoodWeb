...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.0235}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.0647}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.0647}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.0647}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.7824}}@{}}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 18\tabcolsep) * \real{0.2302}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 18\tabcolsep) * \real{0.1439}}
  >{\centering\arraybackslash}p{(\columnwidth - 18\tabcolsep) * \real{0.0719}}
  >{\centering\arraybackslash}p{(\columnwidth - 18\tabcolsep) * \real{0.0719}}
  >{\centering\arraybackslash}p{(\columnwidth - 18\tabcolsep) * \real{0.1007}}
  >{\centering\arraybackslash}p{(\columnwidth - 18\tabcolsep) * \real{0.0863}}
  >{\centering\arraybackslash}p{(\columnwidth - 18\tabcolsep) * \real{0.0935}}
  >{\centering\arraybackslash}p{(\columnwidth - 18\tabcolsep) * \real{0.0504}}
  >{\centering\arraybackslash}p{(\columnwidth - 18\tabcolsep) * \real{0.0719}}
  >{\centering\arraybackslash}p{(\columnwidth - 18\tabcolsep) * \real{0.0791}}@{}}
...
of predators; TL: Trophic Level; TopRole: Topological role, where
